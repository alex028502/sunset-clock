...
icons: public/48x48.png public/96x96.png public/192x192.png public/64x64.png public/favicon.ico
public/48x48.png: public/face.svg makefile
	convert -strip -background none -resize '48x48!' $< $@
public/96x96.png: public/face.svg makefile
	convert -strip -background none -resize '96x96!' $< $@
public/192x192.png: public/face.svg makefile
	convert -strip -background none -resize '192x192!' $< $@
public/64x64.png: public/face.svg makefile
