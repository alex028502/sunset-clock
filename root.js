...
var ClockApp = __webpack_require__(33);

_reactDom2.default.render(_react2.default.createElement(ClockApp, {
...
var Coordinates = __webpack_require__(50);

var formatCoordinates = __webpack_require__(53);

var italianTime = __webpack_require__(55);
var currentTime = __webpack_require__(57);

var reducer = (0, _redux.combineReducers)({
  time: __webpack_require__(58),
  coordinates: __webpack_require__(59),
  page: __webpack_require__(60),
  form: __webpack_require__(61)
});
...
var ClockApp = function (_React$Component) {
  ...
  function ClockApp(props) {
    ...
    var errorMessage = 'using Greenwich until location is updated';

    if (errorMessage && _this.isElectron()) {
      errorMessage = 'Choose Set Coordinates from the File menu to change';
    }

    try {
      var savedCoordinates = props.localStorage.getItem('coordinates');
    ...
    initialState.page = _this.props.document.location.hash;
    initialState.form = { fieldValue: '' };

    _this.store = (0, _redux.createStore)(reducer, Object.assign({
      time: new Date()
    }, initialState), __webpack_require__(62)(window));

    _this.props.window.onpopstate = function () {
  ...
  _createClass(ClockApp, [{
    ...
    value: function render() {
      if (this.store.getState().page === '#set-coordinates') {
        return _react2.default.createElement(CoordinatesForm, { store: this.store, setCoordinates: this.setCoordinates.bind(this) });
      } else {
        return _react2.default.createElement(Clock, {
    ...
    value: function componentDidMount() {
      this.timerID = this.props.setInterval(this.tick.bind(this), 10000);
    ...
    key: 'saveCoordinates',
    value: function saveCoordinates(coordinates) {
      try {
...
function Clock(props) {
  return _react2.default.createElement(
    'div',
    null,
    _react2.default.createElement(ClockFace, { fraction: italianTime(props.time, props.coordinates) }),
    _react2.default.createElement(
      'p',
      null,
      formatCoordinates(props.coordinates)
    ),
    _react2.default.createElement(
      'p',
      { style: { color: 'red' } },
      props.coordinates.error ? props.coordinates.error : ''
    ),
    props.electron ? '' : _react2.default.createElement(
      'p',
      null,
      _react2.default.createElement(
        'button',
...
function interpretCoords(coordinatesString) {
  try {
    var position = new Coordinates(coordinatesString);
    return {
...
var CoordinatesForm = function (_React$Component2) {
  _inherits(CoordinatesForm, _React$Component2);

  function CoordinatesForm() {
    _classCallCheck(this, CoordinatesForm);

    return _possibleConstructorReturn(this, (CoordinatesForm.__proto__ || Object.getPrototypeOf(CoordinatesForm)).apply(this, arguments));
  }
  ...
  _createClass(CoordinatesForm, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          formatCoordinates(this.props.store.getState().coordinates),
          '. To change it, use the form below.  Your position does not have to be that accurate to estimate how much daylight you have left.  It is probably good enought just to look up the city you are in on wikipedia, and copy the coordinates.  When you are finished, click ',
          _react2.default.createElement(
            'a',
            { href: '#' },
            'here'
          ),
          ' to go back to the sunset clock.'
        ),
        _react2.default.createElement(
          'form',
          ...
          _react2.default.createElement(
            'button',
            { type: 'submit', disabled: !interpretCoords(this.props.store.getState().form.fieldValue) },
            'Save'
          )
        )
      );
    ...
    value: function handleSubmit(event) {
      this.props.setCoordinates(Object.assign({}, interpretCoords(this.props.store.getState().form.fieldValue), { error: null }));
      event.preventDefault();
    }
  }]);
...
Validator = __webpack_require__(51);

CoordinateNumber = __webpack_require__(52);
...
var formatcoords = __webpack_require__(54);

module.exports = formatCoordinates;

function formatCoordinates(coordinates) {
  return formatcoords(roundOffToNearestSecond(coordinates.latitude), roundOffToNearestSecond(coordinates.longitude)).format('DDMMssX', { decimalPlaces: 0 });
}
...
var SunCalc = __webpack_require__(56);
...
module.exports = function (now, coordinates) {
  ...
  var day_per_millisecond = 1000 * 60 * 60 * 24;

  for (var t = now.getTime() - 1 * day_per_millisecond; true; t += day_per_millisecond) {
    var sunset = SunCalc.getTimes(new Date(t), coordinates.latitude, coordinates.longitude).sunset;

    var dayEnd = new Date(sunset.getTime() + 30 * 60 * 1000);
